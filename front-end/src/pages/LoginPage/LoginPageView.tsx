...
export function LoginPageView({
  ...
  return (
    <main className="relative flex h-svh min-h-svh items-center justify-center bg-zinc-100/80 p-6 bg-[radial-gradient(circle_at_1px_1px,rgba(0,95,184,0.07)_1px,transparent_0),radial-gradient(80%_60%_at_50%_0%,rgba(0,95,184,0.08),transparent_55%)] [background-size:22px_22px,100%_100%]">
      {isRestoringSession ? (
        <div
