  ...
  return (
    <main className="relative min-w-0 px-3 py-4 pb-6 md:px-4 md:py-8 max-md:landscape:flex max-md:landscape:min-h-svh max-md:landscape:flex-col max-md:landscape:overflow-hidden max-md:landscape:py-2 max-md:landscape:pr-3">
      {currentPallet && token ? (
        <button
          type="button"
          className="fixed right-2 top-2 z-[45] hidden size-8 items-center justify-center rounded-lg border border-zinc-200/90 bg-white/95 text-brand shadow-sm transition-colors hover:bg-brand/10 focus-visible:outline-none focus-visible:ring-[3px] focus-visible:ring-brand/25 max-md:landscape:inline-flex"
      ...
      <div className="mx-auto w-full min-w-0 max-w-6xl max-md:landscape:flex max-md:landscape:min-h-0 max-md:landscape:flex-1 max-md:landscape:flex-col">
        ...
        <div className="mb-4 flex min-w-0 flex-col gap-3 max-md:landscape:hidden md:mb-6 sm:flex-row sm:items-start sm:justify-between">
          {currentPallet ? (
